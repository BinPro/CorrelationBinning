...
time ../programs/generate_contigs.py $DATA_PATH"/parsed_taxonomy_2_2_2013-03-05_complete.txt" -o $RESULTS_PATH"/contigs_2_2_new_100_10000.fna" -d $DATA_PATH"/all_fna" -c 100 -p "genomes" --contig_min_length 10000 --contig_max_length 10000
