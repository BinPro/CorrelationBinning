...
def main(input_files, output_file, levels, x, y):
    fig = plt.figure()
    ax = plt.subplot(111)
...
if __name__=="__main__":
    ...
    parser.add_argument('-x', choices=RocAxisFuns.FUNS,
                        help='The function to be used for the x-dimension')
    parser.add_argument('-y', choices=RocAxisFuns.FUNS,
                        help='The function to be used for the y-dimension')

    args = parser.parse_args()

    main(args.files, args.output, args.levels, args.x, args.y)
